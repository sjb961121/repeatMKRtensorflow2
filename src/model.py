...
class MKR(Model):
    ...
    def _build_low_layers(self, args):
        ...
        for _ in range(args.L):
            self.user_mlp = MLP(input_dim=args.dim, output_dim=args.dim)
            self.tail_mlp = MLP(input_dim=args.dim, output_dim=args.dim)
            self.cc_unit = CrossCompressUnit(args.dim)
